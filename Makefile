##############################################
# OpenWrt Makefile for omegaSocketLCD program
#
#
...
define Package/omegaSocketLCD/description
	App for controling 2x16 LCD on Omega2 via Socket
endef
...
# build a package.
$(eval $(call BuildPackage,omegaSocketLCD))
